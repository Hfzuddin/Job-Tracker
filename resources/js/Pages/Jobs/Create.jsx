...
export default function Create({ auth }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-white leading-tight transition-colors">Add New Job Application</h2>}
        >
            <Head title="Add Job" />
                        ...
                        <section className="max-w-4xl">
                            <header>
                                ...
                                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                    Provide the information for the job you have applied to.
                                </p>
                            </header>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <TextInput
                                            ...
                                            placeholder="e.g. Google, Apple, Local Tech Inc."
                                            isFocused
                                        />
